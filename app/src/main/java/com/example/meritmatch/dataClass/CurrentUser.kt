...
data class CurrentUser(
    ...
    val tasks: List<Task> = listOf( Task(0,"","", "",0.0, false, false, false)),
    val rtasks: List<Task> = listOf( Task(0,"","", "",0.0, false, false, false)),
    val ctasks: List<Task> = listOf( Task(0,"","", "",0.0, false, false, false)),
    val ptasks: List<Task> = listOf( Task(0,"","", "",0.0, false, false, false)),
