...
@Composable
fun UserScreen(viewModel: AppViewModel, mainNav: NavController, notification:(text:String)->Unit){
    ...
    ModalNavigationDrawer(
        ...
        Scaffold(
            ...
            NavHost(navController = navControllerUser, startDestination = com.example.meritmatch.UserScreen.account.route){
                composable(com.example.meritmatch.UserScreen.account.route){Account(viewModel) { text -> notification(text) } }
